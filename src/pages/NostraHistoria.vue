...
<template>
  ...
  my-10 px-10 lg:px-20 2xl:px-50">
    ...
    <section v-for="item in page.items.filter(i => i.type === 'nostra-concept')" :key="item.id"
      class="lg:h-100 bg-ardoise concept mt-10 px-10 lg:px-20 2xl:px-50 flex flex-wrap items-center">
    ...
    <section v-for="item in page.items.filter(i => i.type === 'mission')" :key="item.id"
      class="lg:h-100 bg-crepe/20 px-10 lg:px-20 2xl:px-50 flex flex-wrap lg:flex-row-reverse items-center">
    ...
    <section v-for="item in page.items.filter(i => i.type === 'valeur')" :key="item.id" class=" my-10 px-10 lg:px-20 2xl:px-50 flex flex-wrap items-center">
      <div class="  flex-auto lg:flex-2/4 lg:py-10 2xl:ps-60">
        <h2>{{ item.titre }}</h2>
